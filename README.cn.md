...
[![x-cmd/install — hledger Code Quality Monitoring Repo Card](https://repo.x-cmd.io/hledger.svg?lang=zh)](https://x-cmd.com/install/hledger)
...
合计: **61,352** 行代码（覆盖前 5 种语言、共 **255** 个文件）。

| 语言 | 代码 | 注释 | 空行 | 文件数 |
|------|-----:|-----:|-----:|------:|
| Haskell | 35,163 | 17,229 | 5,994 | 184 |
...
- **Star**: 4,711 · **Fork**: 414 · **开放 issue**: 1,688 · **贡献者**: 181

## 累计统计

- **发布数**: 62 · **已合并 PR**: 775 · **开放 PR**: 9 · **已关闭 issue**: 1364 · **开放 issue**: 324 · **提交数**: 15994
...
_数据快照: `data/card/260921.yml` · 2026-09-21T06:01:05Z._
