...
[![x-cmd/install — hledger Code Quality Monitoring Repo Card](https://x-cmd.com/repo-card/hledger.svg?lang=zh)](https://x-cmd.com/install/hledger)
...
合计: **61,648** 行代码（覆盖前 5 种语言、共 **253** 个文件）。
...
- **Star**: 4,726 · **Fork**: 416 · **开放 issue**: 1,688 · **贡献者**: 181

## 累计统计

- **发布数**: 61 · **已合并 PR**: 779 · **开放 PR**: 5 · **已关闭 issue**: 1367 · **开放 issue**: 321 · **提交数**: 16060
...
_数据快照: `data/card/260923.yml` · 2026-09-23T06:22:21Z._
