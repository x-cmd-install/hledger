...
![hledger](https://repo.x-cmd.io/hledger.svg?lang=zh)
...
合计: **60,769** 行代码（覆盖前 5 种语言、共 **253** 个文件）。
...
- **上游仓库**: <https://github.com/simonmichael/hledger>
...
- **Star**: 4,707 · **Fork**: 414 · **开放 issue**: 1,685 · **贡献者**: 181

## 累计统计

- **发布数**: 62 · **已合并 PR**: 774 · **开放 PR**: 6 · **已关闭 issue**: 1363 · **开放 issue**: 322 · **提交数**: 15907
...
- **编辑包条目**: <https://github.com/x-cmd/install/edit/main/hledger.yml>（或索引实际使用的路径）

本页面的数据（card / loc / scorecard / release）由 [x-cmd-install-action](https://github.com/x-cmd-install/x-cmd-install-action) 自动采集，每日重新生成。**安装行为**（版本选择、平台差异、依赖处理）的改进应提交到上游索引。

_数据快照: `data/card/260915.yml` · 2026-09-15T06:10:16Z._
